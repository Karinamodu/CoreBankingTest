...
namespace CoreBanking.Infrastructure.Migrations
{
    ...
    [Migration("20251113143040_AddAccountMaintenanceProperties")]
    partial class AddAccountMaintenanceProperties
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CoreBanking.Core.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastActivityDate = new DateTime(2024, 10, 10, 0, 0, 0, 0, DateTimeKind.Utc),
                            Status = "Active"
                        });
                });
