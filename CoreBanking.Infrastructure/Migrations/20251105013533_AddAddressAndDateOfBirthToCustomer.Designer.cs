...
namespace CoreBanking.Infrastructure.Migrations
{
    ...
    [Migration("20251105013533_AddAddressAndDateOfBirthToCustomer")]
    partial class AddAddressAndDateOfBirthToCustomer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CoreBanking.Core.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateOpened = new DateTime(2025, 10, 16, 1, 35, 32, 79, DateTimeKind.Utc).AddTicks(66),
                            IsActive = true,
                            IsDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("CoreBanking.Core.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2025, 10, 6, 1, 35, 32, 76, DateTimeKind.Utc).AddTicks(7823),
